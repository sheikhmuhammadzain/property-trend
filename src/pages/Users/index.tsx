            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-black">{filteredUsers.length}</p>
                </div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b-2 border-black">
                    <th className="text-left py-4 px-6 font-semibold text-black">Avatar</th>
                    <th className="text-left py-4 px-6 font-semibold text-black">Name</th>
                    <th className="text-left py-4 px-6 font-semibold text-black">Email</th>
                    <th className="text-left py-4 px-6 font-semibold text-black">Role</th>
                    <th className="text-left py-4 px-6 font-semibold text-black">Status</th>
                    <th className="text-left py-4 px-6 font-semibold text-black">Registered</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <Badge 
                          ...
                          className={user.is_verified ? "bg-green-600 text-white border-green-600" : "bg-gray-200 text-black border-gray-300"}
                        >
